...
# Show a simple dialog asking for the IP address
ip_address = simpledialog.askstring(title="IP Address",
                                    prompt="Please enter your IP address:")

# Use the entered IP address in the VideoCapture
cap = cv2.VideoCapture(f'http://{ip_address}:8080/video')  # Modify the URL format
